...
function Testimonials() {
  return (
    <section className="flex justify-center items-center bg-primary max-md:p-20 w-full md:h-screen text-white">
      <main className="relative flex justify-center items-center bg-cover bg-no-repeat bg-center bg-shadow max-md:py-20 border-2 border-white/15 rounded-2xl w-[90%] h-[70%]">
